...
region_num = [1, 2]
position_vacancies = [117404, 37960]
...
plot = ax.bar(region_num, position_vacancies, edgecolor='black', color=[colour.CSS4_COLORS.get('blue'),
                                                                        colour.CSS4_COLORS.get('green'),
