...
position_vacancies = [2619+130037+78000+4404, 53560+35893+7092, 67473+12257+3859, 5151+7741+30503, 43279+5105]
...
plot = ax.bar(region_num, position_vacancies, edgecolor='black', color=[colour.CSS4_COLORS.get('darkblue'),
                                                                        ...
                                                                        matplotlib.cm.ScalarMappable(norm=colour.Normalize(vmin=0, vmax=1), cmap='winter'),
