...
position_vacancies = [2619+130037+78967+4367, 54586+36351+7237, 67632+12384+3872, 5138+7802+31252, 43547+5087]
...
for rect in plot:
    ...
    if rect is not None:
        ...
        if counter == 4:
            ...
            ax.imshow(X=gradient, cmap='winter', extent=(bar_center - 0.5, bar_center + 0.5, 0, bar_height), aspect='auto' )
