...
position_vacancies = [2382+118969+70387+4144, 48672+33781+6576, 61256+10843+3623, 4751+7221+28352, 41259+4967]
...
plt.title("2025/01 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20)

# plt.ylabel("")
plt.xlabel("參考資料 Reference  https://archive.ph/Bjrvq")
