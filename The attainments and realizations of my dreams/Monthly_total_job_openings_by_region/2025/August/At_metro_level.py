...
position_vacancies = [2548+125333+77120+4472, 54232+35557+7123, 64774+11679+3769, 4984+7987+30050, 42510+4816]
...
plt.title("2025/08 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20)

# plt.ylabel("")
plt.xlabel("參考資料 Reference  https://archive.ph/pMkqg")
