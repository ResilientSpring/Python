...
position_vacancies = [2550+128831+76220+4804, 51404+35238+7004, 67413+11783+3960, 4991+7755+29815, 42698+5253]
...
# plt.ylabel("")
plt.xlabel("參考資料 Reference  https://archive.ph/5VB0A")

plt.ylim(40000, 200000)

img = image.imread('cc-zero.png')

plt.figimage(X=img, xo=800, yo=800, alpha=0.9)

# Insert text watermark [1]
plt.text(x=0.6, y=0.7, s="CC0 Public Domain 無版權圖片", fontsize=40, color='grey', alpha=0.9,
