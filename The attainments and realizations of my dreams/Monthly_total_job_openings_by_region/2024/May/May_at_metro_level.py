...
position_vacancies = [2464+127764+75057+4738, 50702+34801+7110, 66764+11576+4078, 4900+7655+29402, 42027+5057]
...
plt.title("2024/05 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20)

# plt.ylabel("")
plt.xlabel("參考資料 Reference  https://archive.ph/akuc4")

plt.ylim(39000, 190000)
